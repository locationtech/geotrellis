...
trait Implicits {
  implicit class withEuclideanDistanceTileCoordinateMethods(val self: Iterable[Coordinate]) extends EuclideanDistanceTileCoordinateMethods
  ...
  implicit class withEuclideanDistanceTileMethods(val self: Iterable[Point]) extends EuclideanDistanceTileMethods
