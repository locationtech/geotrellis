...
/**
  ...
  */
abstract class RasterCropMethods[T <: CellGrid[Int]: (? => CropMethods[T])] extends CropMethods[Raster[T]] {
  import Crop.Options
...
abstract class MultibandTileRasterCropMethods extends RasterCropMethods[MultibandTile]
