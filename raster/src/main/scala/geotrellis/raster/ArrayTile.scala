...
object ArrayTile {
  def alloc(t: CellType, cols: Int, rows: Int): MutableArrayTile =
    t match {
      ...
      case ByteCellType   => RawByteArrayTile.ofDim(cols, rows)
  ...
  def empty(t: CellType, cols: Int, rows: Int): MutableArrayTile =
    t match {
      ...
      case ByteCellType   => RawByteArrayTile.empty(cols, rows)
  ...
  def fromBytes(bytes: Array[Byte], t: CellType, cols: Int, rows: Int): MutableArrayTile =
    t match {
      ...
      case ShortCellType  => ShortArrayTile.fromBytesRaw(bytes, cols, rows)
  ...
  def fromBytes(bytes: Array[Byte], t: CellType, cols: Int, rows: Int, replaceNoData: Double): MutableArrayTile =
    t match {
      ...
      case ByteCellType   => RawByteArrayTile.fromBytes(bytes, cols, rows, replaceNoData.toByte)
