...
object ColorRamps {
  ...
  val HeatmapBlueToYellowToRedSpectrum = Array(
  ...
  val HeatmapDarkRedToYellowWhite = Array(
  ...
  val HeatmapLightPurpleToDarkPurpleToWhite = Array(
  ...
  val ClassificationBoldLandUse = Array(
  ...
  val ClassificationMutedTerrain = Array(
