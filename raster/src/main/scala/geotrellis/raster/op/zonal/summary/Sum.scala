...
object Sum extends TileIntersectionHandler[Long, Long] with Serializable {
...
object SumDouble extends TileIntersectionHandler[Double, Double] with Serializable {
