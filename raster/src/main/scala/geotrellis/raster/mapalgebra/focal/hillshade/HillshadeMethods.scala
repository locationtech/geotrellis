...
trait HillshadeMethods extends MethodExtensions[Tile] {
  /**
    ...
    */
  def hillshade(cs: CellSize, azimuth: Double = 315, altitude: Double = 45, zFactor: Double = 1.0, bounds: Option[GridBounds[Int]] = None, target: TargetCell = TargetCell.All): Tile =
