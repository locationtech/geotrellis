...
class ColorSpec extends FunSpec with MustMatchers {
  describe("chooseColors") {
    ...
    it("should provide 1 color") {
      getColorStringLinear(1) must be === "FF0000"
      getColorStringArray(1) must be === "FF0000"
    }

    it("should provide 2 colors") {
      getColorStringLinear(2) must be === "FF0000,0000FF"
      getColorStringArray(2) must be === "FF0000,0000FF"
    }

    it("should provide 3 colors") {
      getColorStringLinear(3) must be === "FF0000,80007F,0000FF"
      getColorStringArray(3) must be === "FF0000,80007F,0000FF"
    }

    it("should provide 9 colors") {
      getColorStringLinear(9) must be === "FF0000,E0001F,C0003F,A0005F,80007F,60009F,4000BF,2000DF,0000FF"
      getColorStringArray(9) must be === "FF0000,E0001F,C0003F,A0005F,80007F,60009F,4000BF,2000DF,0000FF"
    }
