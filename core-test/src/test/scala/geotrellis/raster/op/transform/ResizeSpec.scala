...
class ResizeSpec extends FunSpec 
  ...
  describe("ResizeRaster") {
    it("should resize quad8 correctly") {
      ...
      val resize1 = get(Resize(io.LoadFile("core-test/data/quad8.arg"), re))
      
      val resize2 = get(Resize(io.LoadFile("core-test/data/quad8.arg"), 40, 40))
    ...
    it("should resize quad8 to 4x4 correctly") {
      val raster = get(Resize(io.LoadFile("core-test/data/quad8.arg"), 4, 4))
