...
trait OutputPlugin[K] {
  ...
  def writer(method: KeyIndexMethod[K, KeyIndex[K]], props: Parameters): Writer[LayerId, RasterRDD[K]]

  def apply(id: LayerId, rdd: RasterRDD[K], method: KeyIndexMethod[K, KeyIndex[K]], props: Map[String, String]): Unit =
