...
//   def apply(): DatumParameters = new DatumParameters(None, Array[Double](), None)
// }
...
//       case _ => Datum("User", ellipsoid, "User-defined", datumTransform)
//     }
//   }
...
//     DatumParameters(optDatum, datumTransform, optEllipsoid, a, es)

//   def setDatum(datum: Datum): DatumParameters =
//     DatumParameters(Some(datum), datumTransform, optEllipsoid, a, es)
...
//       a * (1 - es * (DatumParameters.SIXTH + es * (DatumParameters.RA4 + es * DatumParameters.RA6))), es)
