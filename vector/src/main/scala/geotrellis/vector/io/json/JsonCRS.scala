...
/**
  * Abstract trait for various implementations of Coordinate Reference
  * System values
  *
...
/**
  * A CRS object which indicates a coordinate reference system by
  * name.
  *
...
/**
  ...
  * @param format must be a string that hints at the format used to represent CRS parameters at the provided URI.
...
/**
  * Used as a named tuple to extract and insert CRS field in GeoJSON
  * objects.
  */
