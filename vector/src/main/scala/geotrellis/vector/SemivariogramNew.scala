...
//case object Check extends ModelType
...
object SemivariogramNew {
  ...
  def apply(pts:Seq[PointFeature[Int]],radius:Option[Int]=None,lag:Int=0,model:ModelType):Double => Double = {
    ...
    model match {
      ...
      case Gaussian =>
        println("Empirical Semivariogram")
        for((x,y) <- empiricalSemivariogram) {
          println(x + " " + y)
        }
        ...
        lsb.start(Array.fill[Double](empiricalSemivariogram.length)(1))
        //lsb.weight(new DiagonalMatrix(Array.fill[Double](empiricalSemivariogram.length)(1)))
        //lsb.checker(null)
        ...
        */
        ...
        val definition = explicitGaussian(optimalValues(0), optimalValues(1), optimalValues(2))
        cfor(0)(_ < problem.x.length, _ + 1) { i =>
          println(problem.x(i) + " " + problem.y(i) + " => " + definition(problem.x(i)))
        }
        println(definition(0))
        println(definition(0.1))
        definition
      ...
      case Exponential =>
        ...
        val definition = explicitExponential(optimalValues(0), optimalValues(1), optimalValues(2))
        cfor(0)(_ < problem.x.length, _ + 1) { i =>
          println(problem.x(i) + " " + problem.y(i) + " => " + definition(problem.x(i)))
        }
        definition
      case Circular =>
        ...
        val definition = explicitCircular(optimalValues(0), optimalValues(1), optimalValues(2))
        cfor(0)(_ < problem.x.length, _ + 1) { i =>
          println(problem.x(i) + " " + problem.y(i) + " => " + definition(problem.x(i)))
        }
        definition
      case Spherical =>
        ...
        val definition = explicitSpherical(optimalValues(0), optimalValues(1), optimalValues(2))
        cfor(0)(_ < problem.x.length, _ + 1) { i =>
          println(problem.x(i) + " " + problem.y(i) + " => " + definition(problem.x(i)))
        }
        definition
      case Wave =>
        ...
        val definition = explicitWave(optimalValues(0), optimalValues(1), optimalValues(2))
        cfor(0)(_ < problem.x.length, _ + 1) { i =>
          println(problem.x(i) + " " + problem.y(i) + " => " + definition(problem.x(i)))
        }
        definition
