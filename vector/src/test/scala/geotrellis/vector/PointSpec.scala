...
class PointSpec extends AnyFunSpec with Matchers {
  describe("Point") {
    ...
    it ("should union with a ZeroDimensions and return a MultiPointResult") {
      val p = Point(1,1)
      val zd = MultiPoint(Point(1,1), Point(2,2))
      val result = p | zd
      result should be (MultiPointResult(MultiPoint(Point(1,1), Point(2,2))))
    }
    ...
    it ("should union with a LineString and return a LineStringResult") {
      ...
      val l = LineString(Point(0,0), Point(2,2))
      val result = p | l
      result should be (LineStringResult(LineString(Point(0,0), Point(2,2))))
    }

    it ("should union with a LineString and return a GeometryCollectionResult") {
      val p = Point(1,1)
      val l = LineString(Point(0,0), Point(0,2))
      val expected: GeometryCollection =
        GeometryCollection(points = Seq(Point(1,1)), lines = Seq(LineString(Point(0,0), Point(0,2))))
      val result = p | l
      result match {
    ...
    it ("should union with a Polygon and return a PolygonResult") {
      val pt = Point(1,1)
      val poly = Polygon(LineString(Point(0,0), Point(0,2), Point(2,2), Point(2,0), Point(0,0)))
      val result = pt | poly
    ...
    it ("should union with an empty MultiLineString and return a PointResult") {
      val p = Point(1,1)
      val ls = MultiLineString(Seq())
      val result = p | ls
    ...
    it ("should union with a MultiLineString and return a LineStringResult") {
      val p = Point(1,1)
      val ls = MultiLineString(Seq(LineString(Point(0,0), Point(2,2))))
      val result = p | ls
      result should be (LineStringResult(LineString(Point(0,0), Point(2,2))))
    }

    it ("should union with a MultiLineString and return a MultiLineStringResult") {
      val p = Point(1,1)
      val l1 = LineString(Point(0,0), Point(2,2))
      val l2 = LineString(Point(0,5), Point(5,5))
      val ls = MultiLineString(Seq(l1, l2))
      val result = p | ls
      result should be (MultiLineStringResult(MultiLineString(l1, l2)))
    }
    ...
    it ("should union with a MultiPolygon and return a MultiPolygonResult") {
      val pt = Point(1,1)
      val poly1 = Polygon(LineString(Point(0,0), Point(0,2), Point(2,2), Point(2,0), Point(0,0)))
      val poly2 = Polygon(LineString(Point(10,0), Point(10,2), Point(12,2), Point(12,0), Point(10,0)))
      val polySet = MultiPolygon(Seq(poly1, poly2))
      val result = pt | polySet
      result should be (MultiPolygonResult(MultiPolygon(poly1, poly2)))
    }
    ...
    it ("should difference with another Geometry and return a PointResult") {
      val p = Point(1,1)
      val l = LineString(Point(5,5), Point(11, 4))
      val result = p - l
      result should be (PointResult(Point(1,1)))
    }
    ...
    //   result should be (MultiPointResult(MultiPoint(p2, p1)))
    // }
    ...
    // it ("should symDifference with a LineString and return a LineStringResult") {
    //   val p = Point(1,1)
    //   val l = LineString(Point(0,0), Point(2,2))
    //   val result = p.symDifference(l)
    //   result should be (LineStringResult(l))
    // }

    // it ("should symDifference with a LineString and return a GeometryCollectionResult") {
    //   val p = Point(11,11)
    //   val l = LineString(Point(0,0), Point(2,2))
    //   val expected: GeometryCollection =
    ...
    //   val ps = MultiPoint(Seq(p2, p3))
    //   val result = p1.symDifference(ps)
    //   result should be (MultiPointResult(MultiPoint(p1, p2, p3)))
    // }
    ...
    // it ("should symDifference with an empty MultiLineString and return a PointResult") {
    //   val p = Point(1,1)
    ...
    //   val p = Point(1,1)
    //   val l1 = LineString(Point(0,0), Point(2,2))
    //   val l2 = LineString(Point(0,0), Point(2,0))
    //   val ls = MultiLineString(Seq(l1, l2))
    //   val result = p.symDifference(ls)
    //   result should be (MultiLineStringResult(MultiLineString(l1, l2)))
    // }
    ...
    //   val result = p.symDifference(ls)
    //   result match {
    //     case gc: GeometryCollection => gc should be (expected)
    //     case _ => fail()
    //   }
    // }
