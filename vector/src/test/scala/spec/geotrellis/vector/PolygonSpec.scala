...
class PolygonSpec extends AnyFunSpec with Matchers {
  describe("Polygon") {
    ...
    it("should throw if attempt to construct with unclosed line") {
      intercept[Exception] {
        val p = Polygon(LineString(List[(Double,Double)]((0,0),(1,0),(1,1),(0,1))))
      }
    }

    it ("should be a rectangle if constructed with a rectangular Seq of points") {
      val p = Polygon(LineString(Point(0,0), Point(0,5), Point(5,5), Point(5,0), Point(0,0)))
      p.isRectangle should be (true)
    }

    // it ("should have an area") {
    //   val p = Polygon(LineString(Point(0,0), Point(0,5), Point(5,5), Point(5,0), Point(0,0)))
    //   p.getArea should be (25)
    // }
    ...
    // it ("should have a boundary that is a LineStringResult") {
    //   val l = LineString(Point(0,0), Point(0,5), Point(5,5), Point(5,0), Point(0,0))
    //   val p = Polygon(l)
    //   p.boundary should be (LineStringResult(l))
    // }

    // it ("should have a boundary that is a MultiLineStringResult") {
    //   val l = LineString(Point(0,0), Point(0,5), Point(5,5), Point(5,0), Point(0,0))
    //   val h = LineString(Point(1,1), Point(1,4), Point(4,4), Point(4,1), Point(1,1))
    //   val p = Polygon(l, Seq(h))
    //   p.boundary should be (MultiLineStringResult(Seq(l, h)))
    // }
    ...
    it ("should have an envelope whose points are " +
      ...
      val p = Polygon(l)
      p.extent should be (Extent(0,0,4,2))
    }
    ...
    it ("should intersect with a TwoDimensions and return a MultiLineStringResult") {
      val l1 = LineString(Point(0,0), Point(0,6), Point(5,6), Point(5,0), Point(0,0))
      val p1 = Polygon(l1)
    ...
    it ("should intersect with a TwoDimensions and return a GeometryCollectionResult") {
      val l1 = LineString(Point(0,0), Point(0,5), Point(5,5), Point(5,0), Point(0,0))
      val p1 = Polygon(l1)
      val l2 = LineString(Point(0,4), Point(0,7), Point(5,7), Point(5,5), Point(2,6),
                    Point(2,4), Point(0,4))
      val p2 = Polygon(l2)
    ...
    it ("should union with a Polygon and return a PolygonResult") {
      val l1 = LineString(Point(0,0), Point(0,5), Point(5,5), Point(5,0), Point(0,0))
      val p1 = Polygon(l1)
      val l2 = LineString(Point(0,4), Point(0,7), Point(5,7), Point(5,4), Point(0,4))
      val p2 = Polygon(l2)
      p1 | p2 should be (PolygonResult(Polygon(LineString(Point(0,0), Point(0,4), Point(0,5), Point(0,7),
    ...
    it ("should union with a Polygon and return a MultiPolygonResult") {
      val l1 = LineString(Point(0,0), Point(0,5), Point(5,5), Point(5,0), Point(0,0))
      val p1 = Polygon(l1)
      val l2 = LineString(Point(0,6), Point(0,7), Point(5,7), Point(5,6), Point(0,6))
      val p2 = Polygon(l2)
      p1 | p2 should be (MultiPolygonResult(MultiPolygon(p1, p2)))
    }
    ...
    it ("should union with a MultiPolygon and return a PolygonResult") {
      ...
      val mp = {
        val l2 = LineString(Point(0,4), Point(0,7), Point(5,7), Point(5,4), Point(0,4))
        require(l2.isValid)
        val l3 = LineString(Point(0,3), Point(2,3), Point(2,0), Point(0,3))
        require(l3.isValid)
        val p2 = Polygon(l2)
        require(p2.isValid)
        val p3 = Polygon(l3)
      ...
      require(p1.isValid)
      require(mp.isValid)
      p1 | mp should be (PolygonResult(Polygon(LineString(Point(0,0), Point(0,3), Point(0,4), Point(0,5), Point(0,7),
        Point(5,7), Point(5,5), Point(5,4), Point(5,0), Point(2,0), Point(0,0)))))
    }
    ...
    it ("should make an invalid MultiPolygon into a Polygon") {
      ...
      mpUnion should be (Polygon(LineString(Point(0, 0), Point(0, 4), Point(0, 5), Point(0, 7),
    ...
    it ("should cascade union with a Polygon and return a PolygonResult") {
      ...
      geomList.unionGeometries should be (PolygonResult(Polygon(LineString(Point(0,0), Point(0,4),
    ...
    it ("should cascade union with a Polygon and return a MultiPolygonResult") {
      ...
      val p2 = Polygon(l2)
      val geomList = List(p1, p2)
      geomList.unionGeometries should be (MultiPolygonResult(MultiPolygon(p1, p2)))
    }
    ...
    it ("should cascade union with a MultiPolygon and return a PolygonResult") {
      ...
      geomList.unionGeometries should be (PolygonResult(Polygon(LineString(Point(0,0), Point(0,3), Point(0,4), Point(0,5), Point(0,7),
        Point(5,7), Point(5,5), Point(5,4), Point(5,0), Point(2,0), Point(0,0)))))
    }
    ...
    it ("should difference with a Point and return a PolygonResult") {
      val pt = Point(1,1)
      val poly = Polygon(LineString(Point(0,0), Point(0,4), Point(4,4), Point(4,0), Point(0,0)))
    ...
    it ("should difference with a LineString that matches its exterior and return a PolygonResult") {
      val pt1 = Point(0,0)
      val pt2 = Point(0,4)
      val pt3 = Point(4,4)
      val pt4 = Point(4,0)
      val l = LineString(pt1, pt2, pt3, pt4, pt1)
      val poly = Polygon(LineString(Point(0,0), Point(0,4), Point(4,4), Point(4,0), Point(0,0)))
      l should be (poly.exterior)
      poly - l should be (PolygonResult(poly))
    }

    it ("should difference with a LineString and return a PolygonResult") {
      val pt1 = Point(-2,-2)
      val pt2 = Point(0,0)
      val pt3 = Point(2,2)
      val pt4 = Point(4,4)
      val pt5 = Point(6,6)
      val l = LineString(pt1, pt2, pt3, pt4, pt5)
      val poly = Polygon(LineString(Point(0,0), Point(0,4), Point(4,4), Point(4,0), Point(0,0)))
      poly - l should be (PolygonResult(poly))
    }

    it ("should difference with a MultiLineString and return a PolygonResult") {
      val pt1 = Point(0,0)
      val pt2 = Point(0,4)
      val pt3 = Point(4,4)
      val pt4 = Point(4,0)
      val l1 = LineString(pt1, pt3)
      val l2 = LineString(pt2, pt4)
    ...
    it ("should difference with a Polygon and return a PolygonResult") {
      val p1 = Polygon(LineString(Point(0,0), Point(0,10), Point(10,10), Point(10,0), Point(0,0)))
      val p2 = Polygon(LineString(Point(2,12), Point(2,18), Point(8,18), Point(8,12), Point(2,12)))
    ...
    // it ("should symDifference with a MultiLineString and return a PolygonResult") {
    //   val p = Polygon(LineString(Point(0,0), Point(0,10), Point(10,10), Point(10,0), Point(0,0)))
    //   val ml = MultiLineString(Seq(LineString(Point(5,5), Point(6,6))))
    ...
    //   val p = Polygon(LineString(Point(0,0), Point(0,10), Point(10,10), Point(10,0), Point(0,0)))
    //   val ml = MultiLineString(Seq(LineString(Point(50,50), Point(60,60))))
    //   val expected: GeometryCollection =
    //     GeometryCollection(lines = Seq(LineString(Point(50,50), Point(60,60))), polygons = Seq(p))
    ...
    //   val p1 = Polygon(LineString(Point(0,0), Point(0,10), Point(10,10), Point(10,0), Point(0,0)))
    //   val p2 = Polygon(LineString(Point(10,0), Point(10,10), Point(0,10), Point(0,0), Point(10,0)))
    ...
    //   val p1 = Polygon(LineString(Point(0,0), Point(0,10), Point(10,10), Point(10,0), Point(0,0)))
    //   val p2 = Polygon(LineString(Point(5,0), Point(5,10), Point(10,10), Point(10,0), Point(5,0)))
    //   p1.symDifference(p2) should be (PolygonResult(Polygon(LineString(Point(0,0), Point(0,10), Point(5,10),
    //                                                              Point(5,0), Point(0,0)))))
    // }

    // it ("should symDifference with a Polygon and return a MultiPolygonResult") {
    //   val p1 = Polygon(LineString(Point(0,0), Point(0,10), Point(10,10), Point(10,0), Point(0,0)))
    //   val p2 = Polygon(LineString(Point(15,0), Point(15,10), Point(25,10), Point(25,0), Point(15,0)))
    ...
    it ("should contain a LineString") {
      val p = Polygon(LineString(Point(0,0), Point(0,10), Point(10,10), Point(10,0), Point(0,0)))
      val l = LineString(Point(1,1), Point(9,9))
      p.contains(l) should be (true)
    }

    it ("should contain a MultiLineString") {
      val p = Polygon(LineString(Point(0,0), Point(0,10), Point(10,10), Point(10,0), Point(0,0)))
      val l1 = LineString(Point(1,1), Point(9,9))
      val l2 = LineString(Point(5,5), Point(5,8))
      val ml = MultiLineString(l1, l2)
    ...
    it ("should contain a MultiPolygon") {
      val p1 = Polygon(LineString(Point(0,0), Point(0,10), Point(10,10), Point(10,0), Point(0,0)))
      val p2 = Polygon(LineString(Point(5,0), Point(5,10), Point(10,10), Point(10,0), Point(5,0)))
      val p3 = Polygon(LineString(Point(1,7), Point(1,8), Point(4,7), Point(1,7)))
    ...
    it ("should cross with a LineString") {
      val p = Polygon(LineString(Point(0,0), Point(0,10), Point(10,10), Point(10,0), Point(0,0)))
      val l = LineString(Point(-5,5), Point(15, 5))
      p.crosses(l) should be (true)
    }

    it ("should cross with a MultiLineString") {
      val p = Polygon(LineString(Point(0,0), Point(0,10), Point(10,10), Point(10,0), Point(0,0)))
      val l1 = LineString(Point(3,3), Point(6,6))
      val l2 = LineString(Point(0, 15), Point(15, 15))
      val ml = MultiLineString(l1, l2)
    ...
    it ("should overlap a Polygon") {
      val p1 = Polygon(LineString(Point(0,0), Point(0,10), Point(10,10), Point(10,0), Point(0,0)))
      val p2 = Polygon(LineString(Point(5,5), Point(5,15), Point(15,15), Point(15,5), Point(5,5)))
    ...
    it ("should touch a LineString") {
      val p = Polygon(LineString(Point(0,0), Point(0,10), Point(10,10), Point(10,0), Point(0,0)))
      val l = LineString(Point(10,10), Point(20,20))
      p.touches(l) should be (true)
    }

    it ("should touch a MultiLineString") {
      val p = Polygon(LineString(Point(0,0), Point(0,10), Point(10,10), Point(10,0), Point(0,0)))
      val l1 = LineString(Point(10,10), Point(19,19))
      val l2 = LineString(Point(15,15), Point(15,18))
      val ml = MultiLineString(l1, l2)
    ...
    it ("should touch a Polygon") {
      val p1 = Polygon(LineString(Point(0,0), Point(0,10), Point(10,10), Point(10,0), Point(0,0)))
      val p2 = Polygon(LineString(Point(0,0), Point(0,10), Point(-10,10), Point(-10,0), Point(0,0)))
    ...
    it ("should touch a MultiPolygon") {
      val p1 = Polygon(LineString(Point(0,0), Point(0,10), Point(10,10), Point(10,0), Point(0,0)))
      val p2 = Polygon(LineString(Point(0,0), Point(0,10), Point(-10,10), Point(-10,0), Point(0,0)))
      val p3 = Polygon(LineString(Point(11,17), Point(11,18), Point(14,17), Point(11,17)))
      val mp = MultiPolygon(p2, p3)
    ...
    it ("should be within another Polygon") {
      val p1 = Polygon(LineString(Point(0,0), Point(0,10), Point(10,10), Point(10,0), Point(0,0)))
      val p2 = Polygon(LineString(Point(1,1), Point(1,9), Point(9,9), Point(9,1), Point(1,1)))
    ...
    it ("should maintain immutability over exterior") {
      val p = Polygon(LineString(Point(0,0), Point(0,10), Point(10,10), Point(10,0), Point(0,0)),
                      LineString(Point(11,17), Point(11,18), Point(14,17), Point(11,17)))

      val expected = p.copy
      val coord = p.exterior.points(0).getCoordinate()
