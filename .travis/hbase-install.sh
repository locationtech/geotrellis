...
if [ ! -f hbase-1.2.3-bin.tar.gz ]; then sudo wget -O $HOME/downloads/hbase-1.2.3-bin.tar.gz http://apache-mirror.rbc.ru/pub/apache/hbase/1.2.3/hbase-1.2.3-bin.tar.gz; fi
