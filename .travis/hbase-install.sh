...
if [ ! -f $HOME/downloads/hbase-1.2.3-bin.tar.gz ]; then sudo wget -O $HOME/downloads/hbase-1.2.3-bin.tar.gz http://www-eu.apache.org/dist/hbase/1.2.3/hbase-1.2.3-bin.tar.gz; fi
