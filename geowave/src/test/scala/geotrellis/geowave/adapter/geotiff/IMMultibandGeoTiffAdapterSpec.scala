...
class IMGeoTiffAdapterSpec extends AnyFunSpec with Matchers {
  lazy val uri: String = "src/test/resources/raster/all-ones.tif"

  /** To run this test change "ignore" to "describe" */
  ignore("In Memory GeoTiffAdapterSpec spatial index spec") {
    ...
    lazy val dataTypeAdapter = new GeoTiffAdapter("MultibandGeoTiffDataAdapterSpec".typeName)
