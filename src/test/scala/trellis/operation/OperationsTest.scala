...
class OperationsTest extends FunSuite {
  ...
  val r1 = IntRaster(Array.fill(100)(1), 10, 10, re)
  val r2 = IntRaster(Array.fill(100)(2), 10, 10, re)
  val r3 = IntRaster(Array.fill(100)(3), 10, 10, re)
  val r6 = IntRaster(Array.fill(100)(6), 10, 10, re)
  val r9 = IntRaster(Array.fill(100)(9), 10, 10, re)
