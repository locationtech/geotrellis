 ...
 *
 *   That's an InputFormat for a batch input, you have to specify key ranges
 */
public class CqlBatchInputFormat extends org.apache.hadoop.mapreduce.InputFormat<Long, Row> implements org.apache.hadoop.mapred.InputFormat<Long, Row>
{
    ...
    public List<org.apache.hadoop.mapreduce.InputSplit> getSplits(JobContext context) throws IOException
    {
             ...
             Session session = cluster.connect())
        {
            ...
            List<KeyRange> jobKeyRanges = BatchConfigHelper.getInputKeyRanges(conf);
            for(KeyRange jobKeyRange: jobKeyRanges) {
