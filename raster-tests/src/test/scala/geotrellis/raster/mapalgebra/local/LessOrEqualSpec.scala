...
class LessOrEqualSpec extends AnyFunSpec
                         with Matchers 
                         with RasterMatchers 
                         with TileBuilders {
  describe("LessOrEqual") {
    ...
    it("checks double valued raster against int constant right associative (compare 10 against 10.3, 10 <= 10.3 should be true)") {
