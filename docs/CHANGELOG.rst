...
- ``geotrellis-raster``
  ...
  - **New:** Created the ``geotrellis.raster.mapalgebra.focal.ZFactorCalculator`` to improve slope calculations (`#3014 <https://github.com/locationtech/geotrellis/pull/3014>`_).
