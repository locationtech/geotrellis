...
class NearestNeighborReprojectSpec extends FunSpec
    with TileBuilders
    with TestEngine {

  describe("reprojects tile using nearest neighbor in approximation to GDAL") {

    it ("should (approximately) match a GDAL nearest neighbor interpolation on nlcd webmercator tile") {
