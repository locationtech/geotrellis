...
class HadoopGeoTiffRDDSpec
  ...
  describe("HadoopGeoTiffRDD") {
    it("should read the same rasters when reading small windows or with no windows, SinglebandGeoTiff") {
    ...
    it("should read the same rasters when reading small windows or with no windows, MultibandGeoTiff") {
