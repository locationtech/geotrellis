...
trait ProjectedExtentView[T] extends SimpleLens[T, ProjectedExtent]
...
class Ingest[T: ProjectedExtentView, K: SpatialKeyView](layoutScheme: LayoutScheme)(createKey: (T, SpatialKey) => K) {
