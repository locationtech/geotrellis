...
trait IfCellRasterRDDMethods[K] extends RasterRDDMethods[K] {
  ...
  def localIf(
    cond: Double => Boolean,
    trueValue: Double): RasterRDD[K] = rasterRDD.mapPairs {
  ...
  def localIf(
    cond: Int => Boolean,
    trueValue: Int,
    falseValue: Int): RasterRDD[K] = rasterRDD.mapPairs {
  ...
  def localIf(
    cond: Double => Boolean,
    trueValue: Double,
    falseValue: Double): RasterRDD[K] = rasterRDD.mapPairs {
    case (t, r) => (t, IfCell(r, cond, trueValue, falseValue))
  }
  ...
  def localIf(
    ...
    trueValue: Int): RasterRDD[K] = rasterRDD.combinePairs(other) {
    case ((t1, r1), (t2, r2)) =>
  ...
  def localIf(
    ...
    trueValue: Double): RasterRDD[K] = rasterRDD.combinePairs(other) {
    case ((t1, r1), (t2, r2)) =>
      (t1, IfCell(r1, r2, cond, trueValue))
  }
  ...
  def localIf(
    ...
    cond: (Int, Int) => Boolean,
    trueValue: Int,
    falseValue: Int): RasterRDD[K] = rasterRDD.combinePairs(other) {
    case ((t1, r1), (t2, r2)) =>
  ...
  def localIf(
    ...
    cond: (Double, Double) => Boolean,
    trueValue: Double,
    falseValue: Double): RasterRDD[K] = rasterRDD.combinePairs(other) {
    case ((t1, r1), (t2, r2)) =>
      (t1, IfCell(r1, r2, cond, trueValue, falseValue))
  }
