...
import geotrellis.store.file.{FileAttributeStore, FileLayerHeader, KeyPathGenerator, LayerPath}
...
class FileLayerWriter(
  ...
  def overwrite[
    ...
    M: Encoder: Decoder: Component[_, Bounds[K]]: Semigroup
  ](
    id: LayerId,
  ...
  protected def _write[
    ...
    V: AvroRecordCodec: ClassTag,
    M: Encoder: Component[_, Bounds[K]]
