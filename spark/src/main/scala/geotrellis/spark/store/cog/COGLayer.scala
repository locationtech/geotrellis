...
object COGLayer {
  ...
  def fromLayerRDD[
    ...
    V <: CellGrid[Int]: ClassTag: _ => TileMergeMethods[V]: _ => TilePrototypeMethods[V]: _ => TileCropMethods[V]: GeoTiffBuilder
  ](
  ...
  /**
    ...
    */
  def mergeCOGs[V <: CellGrid[Int]: _ => CropMethods[V]: _ => TileMergeMethods[V]: GeoTiffBuilder](
    previous: GeoTiff[V],
    update: GeoTiff[V]
  ): GeoTiff[V] = {
