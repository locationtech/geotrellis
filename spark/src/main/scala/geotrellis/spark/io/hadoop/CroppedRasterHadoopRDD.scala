...
// class CroppedRasterHadoopRDD[K: Spatial] private (path: Path, gridBounds: GridBounds, sc: SparkContext, conf: Configuration)
//   extends PreFilteredHadoopRDD[SpatialKeyWritable, TileWritable](
//     sc,
