...
class HadoopTileReader[K: AvroRecordCodec: JsonFormat: KeyIndexJsonFormat: ClassTag, V: AvroRecordCodec](val attributeStore: HadoopAttributeStore)
...
object HadoopTileReader {
  def apply[K: AvroRecordCodec: JsonFormat: KeyIndexJsonFormat: ClassTag, V: AvroRecordCodec](attributeStore: HadoopAttributeStore)
    (implicit sc: SparkContext): HadoopTileReader[K, V] =
    new HadoopTileReader[K, V](attributeStore)

  def apply[K: AvroRecordCodec: JsonFormat: KeyIndexJsonFormat: ClassTag, V: AvroRecordCodec](rootPath: Path)
    (implicit sc: SparkContext): HadoopTileReader[K, V] =
