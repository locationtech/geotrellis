...
class KryoRegistrator extends SparkKryoRegistrator {
  override def registerClasses(kryo: Kryo) {
    ...
    kryo.register(classOf[geotrellis.raster.summary.histogram.ArrayHistogram])
    kryo.register(classOf[geotrellis.raster.summary.histogram.CompressedArrayHistogram])
    kryo.register(classOf[geotrellis.raster.summary.histogram.ConstantHistogram])
    kryo.register(classOf[geotrellis.raster.summary.histogram.FastMapHistogram])
    kryo.register(classOf[geotrellis.raster.summary.histogram.Histogram[Any]])
    kryo.register(classOf[geotrellis.raster.summary.histogram.MapHistogram])
    kryo.register(classOf[geotrellis.raster.summary.histogram.MutableHistogram[Any]])
    kryo.register(classOf[geotrellis.raster.summary.histogram.StreamingHistogram])
    ...
    kryo.register(classOf[geotrellis.raster.polygonal.MeanResult])
