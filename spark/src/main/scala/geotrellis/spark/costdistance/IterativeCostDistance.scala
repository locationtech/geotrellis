...
object IterativeCostDistance {
  ...
  /**
    ...
    */
  private [spark] def computeResolution[K: _ => SpatialKey, V: _ => Tile](
  ...
  private def geometryToKeys[K: _ => SpatialKey](
  ...
  private def geometryMap[K: _ => SpatialKey](
    md: TileLayerMetadata[K],
    gs: Seq[Geometry]
  ...
  /**
    ...
    */
  def apply[K: _ => SpatialKey, V: _ => Tile](
    friction: RDD[(K, V)] with Metadata[TileLayerMetadata[K]],
