...
object RDDHistogramEqualization {
  ...
  /**
    ...
    */
  def singleband[K, V: _ => Tile: ClassTag, M](
  ...
  /**
    ...
    */
  def singleband[K, V: _ => Tile: ClassTag, M, T <: AnyVal](
    rdd: RDD[(K, V)] with Metadata[M],
  ...
  /**
    ...
    */
  def multiband[K, V: _ => MultibandTile: ClassTag, M](
    rdd: RDD[(K, V)] with Metadata[M]
  ...
  /**
    ...
    */
  def multiband[K, V: _ => MultibandTile: ClassTag, M, T <: AnyVal](
    rdd: RDD[(K, V)] with Metadata[M],
