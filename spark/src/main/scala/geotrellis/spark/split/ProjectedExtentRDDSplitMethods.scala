...
abstract class ProjectedExtentRDDSplitMethods[K: Component[?, ProjectedExtent], V <: CellGrid: (? => SplitMethods[V])](implicit ev0: Raster[V] => SplitMethods[Raster[V]]) extends MethodExtensions[RDD[(K, V)]] {
